...
test.each([
  { url: 'git+https://github.com/WillBoosterLab/exercode.git', excluded: false },
  { url: 'https://github.com/WillBoosterLab/exercode', excluded: false },
...
test('falls back to the checkout directory name without a repository field', () => {
  expect(isExcludedRepo('/tmp/exercode', {})).toBe(false);
